...
class LoadData( object ):
    ...
    def __init__(self, path, random_seed):
        ...
        self.path = path
        self.linkfile = "D:\Paper\ASNE-master\ASNE-master\data\\doublelink.edgelist"
        self.testlinkfile = "D:\Paper\ASNE-master\ASNE-master\data\\test_pairs.txt"
        self.attrfile = "D:\Paper\ASNE-master\ASNE-master\data\\attr_info.txt"
